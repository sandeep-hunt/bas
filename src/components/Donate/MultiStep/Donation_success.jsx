              ...
              <Card>
                <Card.Body>
                  ...
                  <div className="payment-content">
                    ...
                    <span className="text-center" style={{color: `#959595`}}>Thank you for your generous donation! Your support makes a meaningful difference. Please check your email for the donation receipt.</span>
