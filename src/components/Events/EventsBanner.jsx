    ...
    <React.Fragment>
      <div className="event-banner" style={{ backgroundImage: `url(${Event_bg})` }}>
        <div className="event-banner-inner">
          ...
          <p className='paragraph2 text-white tw-600'>Explore our upcoming events to stay updated on our latest workshops, performances, and cultural gatherings. Dive into the previous events archive to relive the memorable moments and achievements of past celebrations.</p>
        </div>
      </div>
    </React.Fragment>
  )
