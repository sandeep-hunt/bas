...
const Samaveda_Gurukul = ({ settings }) => {
    ...
    return (
        <React.Fragment>
        <Helmet>
            <title>{`${settings?.site_title || "Loading..."} | Samaveda Gurukul`}</title>
            ...
            <Container fluid>
                <div className="projects-content">
                    ...
                    <p>Despite its profound importance, the knowledge of the Saamaveda is dwindling in modern times. There are approximately 1,000 Saama Gayaka-s (singers of the Saama Veda) worldwide, and only a small percentage of them know the entire Saamaveda in its fullness. The *Saamaveda Gurukula* aims to revive this invaluable tradition and pass it on to the next generation.</p>
