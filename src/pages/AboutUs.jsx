        ...
        <React.Fragment>
            ...
            <Container>
                <div className="about-container">
                    ...
                    <div className="auot">
                        <h3 className='text-main text-center tw-600'>Our Team</h3>
                    ...
                    <div className="auab">
                        <h3 className='text-main text-center tw-600'>Advisory Board</h3>
                                            ...
                                            <div key={index}>
                                                <div className="auabcnt-itm">
                                                    <Row>
                                                        ...
                                                        <Col sm={12} md={7}>
                                                            <div className="auabcnt-itmrit">
                                                                <p className='text-main paragraph3' dangerouslySetInnerHTML={{ __html: item.description }}></p>
                                                            </div>
                                                        </Col>
                                                    </Row>
                                                </div>
                    ...
                    <div className="auctu">
                        <h3 className='text-main text-bold'>Contact Us</h3>
                        <Row className='mt-3'>
                            <Col sm={12} md={7}>
                                <Row>
                                    <Col sm={12} md={6}>
                                    ...
                                    <Col sm={12}>
                                        <Form.Group className='mb-3'>
                                            ...
                                            <textarea rows={6} className='form-control' type="text" name="name" />
                                        </Form.Group>
                                    </Col>
                                </Row>
