                                                    ...
                                                    {index % 2 === 0 ? ( // Check if the index is even
                                                        ...
                                                        <>
                                                            ...
                                                            <Col
                                                                sm={12}
                                                                lg={8}
                                                                className="order-2" // Content second by default
                                                            >
                                                                <div
                                                                    className="auabcnt-itmrit"
                                                                    dangerouslySetInnerHTML={{ __html: item.description }}
